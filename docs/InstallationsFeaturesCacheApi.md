...
------------- | ------------- | -------------
[**clean_installation_cache**](InstallationsFeaturesCacheApi.md#clean_installation_cache) | **POST** /v1/cache-cleaner | 
...
------------- | ------------- | ------------- | -------------
 **cache_cleaner_request** | [**CacheCleanerRequest**](CacheCleanerRequest.md)|  | 
